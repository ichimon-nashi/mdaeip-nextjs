...
export const employeeList = [
	...
	{ id: "21531", name: "賴姵潔", rank: "組長", base: "RMQ", typeRating: ["ATR", "B738"] },
	...
	{ id: "21697", name: "陳秋娉", rank: "PR", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "21834", name: "曾淑怡", rank: "PR", base: "TSA", typeRating: ["ATR", "B738"] },
	...
	{ id: "21935", name: "張瑞君", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "22091", name: "林世謙", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "22206", name: "郭蒼龍", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "22239", name: "顧安琪", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	...
	{ id: "33107", name: "戴家芬", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	...
	{ id: "36657", name: "方僅", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "36675", name: "余明真", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "36693", name: "王于真", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	...
	{ id: "51755", name: "林佳勳", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "53371", name: "許文采", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "53385", name: "陳穎柔", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "53403", name: "蔡婉伶", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	{ id: "53417", name: "郭潔", rank: "LF", base: "TSA", typeRating: ["ATR", "B738"] },
	...
	{ id: "60424", name: "張家傑", rank: "FA", base: "TSA", typeRating: ["ATR"] },
	{ id: "60425", name: "林宣妤", rank: "FS", base: "TSA", typeRating: ["ATR"] },
	{ id: "60427", name: "許寧芮", rank: "FS", base: "TSA", typeRating: ["ATR"] },
	{ id: "60537", name: "楊品凡", rank: "FA", base: "TSA", typeRating: ["ATR"] },
	{ id: "60538", name: "黃丹喬", rank: "FA", base: "TSA", typeRating: ["ATR"] },
	{ id: "60539", name: "何芳瑜", rank: "FS", base: "TSA", typeRating: ["ATR"] },
	{ id: "60540", name: "葉芮君", rank: "FS", base: "TSA", typeRating: ["ATR"] },
	...
	{ id: "56392", name: "許毓倫", rank: "FS", base: "KHH", typeRating: ["ATR", "B738"] },
	{ id: "59161", name: "王儀珺", rank: "FS", base: "KHH", typeRating: ["ATR", "B738"] },
	{ id: "59230", name: "葉容婷", rank: "FS", base: "KHH", typeRating: ["ATR", "B738"] },
	{ id: "59262", name: "劉紋瑄", rank: "LF", base: "KHH", typeRating: ["ATR", "B738"] },
	{ id: "59822", name: "郭惟歆", rank: "LF", base: "KHH", typeRating: ["ATR", "B738"] },
	{ id: "60426", name: "陳筱雅", rank: "FS", base: "TSA", typeRating: ["ATR"] },
	{ id: "60428", name: "江奕蓁", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	{ id: "60429", name: "李芷璇", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	{ id: "60430", name: "蕭芷瑄", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	{ id: "60431", name: "馬家祺", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	{ id: "60432", name: "謝佳容", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	{ id: "60433", name: "張庭瑜", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	{ id: "60543", name: "城珮瑜", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	{ id: "60544", name: "鍾念濡", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	{ id: "60545", name: "黃馨平", rank: "FS", base: "KHH", typeRating: ["ATR"] },
	...
	{ id: "21747", name: "王顧澤", rank: "PR", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "21899", name: "張凱蒂", rank: "PR", base: "RMQ", typeRating: ["ATR", "B738"] },
	...
	{ id: "35316", name: "于騏維", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "33447", name: "劉怡妏", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "36932", name: "王翊庭", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "38034", name: "陳怡秀", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "39361", name: "陶宏卿", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "39375", name: "申宜平", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "39393", name: "陳琬君", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "39444", name: "李宜家", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "39476", name: "王茹薇", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51690", name: "楊育芬", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51736", name: "陳凱玫", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51740", name: "郭幸甄", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51769", name: "萬芊筠", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51787", name: "呂茜雯", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51791", name: "何思薇", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51805", name: "童思嘉", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51856", name: "黃郁涵", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "51860", name: "張純寧", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "53352", name: "葉馨", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "53421", name: "李雨潔", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "53435", name: "歐泓潔", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "53449", name: "呂宜鄉", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "53453", name: "賴貞伶", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "53468", name: "張馝芸", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "53472", name: "李榛榛", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "53518", name: "紀沛晴", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "55015", name: "沈蔓芳", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "55047", name: "顏子瑄", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "55102", name: "林菀柔", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "55152", name: "左益霖", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "55166", name: "陳柔蓁", rank: "LF", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "55171", name: "莊泓楷", rank: "FA", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "56319", name: "周雅琦", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	...
	{ id: "59276", name: "趙芷綾", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "59280", name: "張仲儀", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "54487", name: "葉玉婷", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
	{ id: "55658", name: "徐孟霖", rank: "FS", base: "RMQ", typeRating: ["ATR", "B738"] },
];
...
export const getAllSchedulesForMonth = async (month) => {
	...
	try {
		...
		const { data, error } =
			await scheduleHelpers.getSchedulesForMonth(month);
		...
		const transformedSchedules = data
			.map((schedule) => {
				...
				if (!schedule.duties || !Array.isArray(schedule.duties)) {
					console.error(
						`Invalid duties data for employee ${employeeId}:`,
						schedule.duties,
					);
					return null;
				}
				...
				console.log(
					`Transformed schedule for ${employee.name} (${employee.base}):`,
					{
						id: transformed.employeeID,
						name: transformed.name,
						base: transformed.base,
						sampleDays: Object.entries(transformed.days).slice(
							0,
							3,
						),
					},
		...
		console.log(
			`Total transformed schedules: ${transformedSchedules.length}`,
		);
		console.log("Bases in transformed schedules:", [
			...new Set(transformedSchedules.map((s) => s.base)),
		]);

		// Sort by employeeList order before caching
		const sortedSchedules =
			sortSchedulesByEmployeeListOrder(transformedSchedules);
...
export const getSchedulesByBase = async (month, base) => {
	...
	console.log(
		`getSchedulesByBase called with month: ${month}, base: ${base}`,
	);

	const allSchedules = await getAllSchedulesForMonth(month);
	console.log(
		`Got ${allSchedules.length} schedules from getAllSchedulesForMonth`,
	);
	console.log(`Available bases in schedules:`, [
		...new Set(allSchedules.map((s) => s.base)),
	]);
	...
	const filteredSchedules =
		base === "ALL"
			...
			: allSchedules.filter((schedule) => {
					...
					console.log(
						`Employee ${schedule.name} (${schedule.employeeID}) base: ${schedule.base}, matches ${base}: ${matches}`,
					);
					return matches;
				});

	console.log(
		`Filtered schedules for base ${base}: ${filteredSchedules.length}`,
	);
	console.log(
		`Filtered employees:`,
		filteredSchedules.map((s) => `${s.name} (${s.base})`),
	);
...
export const getFlightDutyForEmployee = async (employeeId, month) => {
	...
	try {
		...
		const { data, error } =
			await flightDutyHelpers.getFlightDutyForEmployee(employeeId, month);
...
export const getAllFlightDutiesForMonth = async (month) => {
	...
	try {
		...
		const { data, error } =
			await flightDutyHelpers.getFlightDutiesForMonth(month);
...
export const getFlightDutyForMRT = async (employeeId, month) => {
	try {
		console.log(
			`Fetching MRT flight duty for employee ${employeeId}, month ${month}`,
		);
		...
		for (let day = 1; day <= daysInMonth; day++) {
			...
			if (
				...
				bestMatch = flightDutyMap[dutyCode].find(
					(duty) =>
						duty.schedule_type === "special" &&
						duty.special_date === day,
				);
				...
				if (!bestMatch) {
					bestMatch = flightDutyMap[dutyCode].find(
						(duty) =>
							duty.schedule_type === "regular" &&
							duty.day_of_week === adjustedDayOfWeek,
					);
				}
				...
				if (bestMatch) {
					...
					dailyFlightInfo[`${year}-${monthNum - 1}-${day}`] =
						flightInfo;
				}
			}
		}
...
export const getFlightDutyDetailsForMRT = async (dutyCode, date, month) => {
	try {
		...
		console.log(
			`Querying MRT flight duty for duty_code: ${dutyCode}, day: ${day}, dayOfWeek: ${dayOfWeek}, month: ${month}`,
		);
		...
		const matchingDuties = flightDuties.filter(
			(duty) => duty.duty_code === dutyCode,
		);
