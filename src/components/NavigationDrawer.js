	...
	const sections = [
		{
			...
			items: [
				...
				},
				{
					...
					icon: <PngIcon src="/assets/CLB.png" alt="CLB Generator" />,
					path: "/clb-generator",
					color: "#0891b2",
					hasAccess: hasAppAccess(user, "clb_generator"),
				},
				{
					id: "etr-generator",
					title: "eTR產生器",
			...
			items: [
				{
					...
					icon: (
						<PngIcon src="/assets/fatigue.png" alt="MRT Checker" />
					),
					path: "/MRTChecker",
					color: "#059669",
		...
		},
		{
			...
			items: [
				...
				},
				{
					...
					icon: (
						<PngIcon
							src="/assets/groundscheduleplanner.png"
							alt="Ground Roster"
						/>
					),
					path: "/ground-roster",
		...
		<>
			...
			>
				...
				<div className={styles.drawerFooter}>
					<div className={styles.appVersion}>豪神APP v5.5.10</div>
				</div>
			</div>
		</>
	);
